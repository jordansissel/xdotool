...
xdotool can read a list of commands via stdin or a file if you want.
...
=item * Read commands from a redirected file (uses isatty(0) to detect redirection on stdin)
