...
Notation: Some documentation uses I<[window=%1]> to denote an optional
...
The default options are C<--name --class --classname>
...
=item B<getwindowpid> I<[window=%1]>
...
=item B<getwindowname> I<[window=%1]>
...
=item B<getwindowgeometry> [options] I<[window=%1]>
...
=item B<windowsize> [options] [window=%1] width height
...
=item B<windowmove> I<[options]> I<[window=%1]> I<x> I<y>
...
=item B<windowfocus> I<[options]> I<[window=%1]>
...
=item B<windowmap> I<[options]> I<[window=%1]>
...
=item B<windowminimize> I<[options]> I<[window=%1]>
...
=item B<windowreparent> I<[source_window=%1]> I<destination_window>
...
=item B<windowactivate> I<[options]> I<[window=%1]>
...
=item B<set_desktop_for_window> I<[window=%1]> I<desktop_number>

Move a window to a different desktop. If no window is given, %1 is the
default. See L<WINDOW STACK> and L<COMMAND CHAINING> for more details.

=item B<get_desktop_for_window> I<[window=%1]>
